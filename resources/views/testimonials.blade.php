      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-3">
              <div class="site-logo">
                <a href="{{ route('homePage') }}"><strong>CarRental</strong></a>
              </div>
            </div>
          ...
          <div class="row align-items-end ">
            <div class="col-lg-5">
              ...
              <div class="intro">
                ...
                <div class="custom-breadcrumbs"><a href="{{ route('homePage') }}">Home</a> <span class="mx-2">/</span> <strong>Testimonials</strong></div>
              </div>
